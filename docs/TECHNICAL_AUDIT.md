# ChainMaid — Technical Audit

Scope: ChainMaid release baseline. This audit mirrors the FreeEQ8 / MeterMaid
structure so readers can compare plugins apples-to-astructure sSource layout
- `ChainMaid*/Source/PluginProcessor.{h,cpp}` — audio processor + parameter layout
- `ChainMaid*/Source/PluginEditor.{h,cpp}` — custom-painted UI
- `ChainMaid*/CMakeLists.txt` — JUCE plugin build
...
## Standards
ChainMaid is built with JUCE 8.0.0 (C++20) and targets VST3 / AU / Standalone
